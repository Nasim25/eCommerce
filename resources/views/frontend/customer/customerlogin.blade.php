                ...
                <!--page-title-->
                    ...
                    <fieldset class="col2-set">
                        <div class="col-1 new-users">
                            ...
                            @enderror
                            <div class="content">
                             <form method="POST" id="signup" action="{{url('customer/register')}}" id="login-form">
                                @csrf
                                <!-- registration -->
                                                        ...
                                                        <fieldset class="">
                                                            <ul>
                                                                ...
                                                                <li>
                                                                    <div class="customer-name">
                                                                        <div class="input-box name-firstname">
                                                                            <label for="mobile"><em class="required">*</em>Mobile</label>
                                                                            <br>
                                                                            <input name="mobile" id="mobile" title="mobile" class="input-text required-entry" type="text">
                                                                        </div>
                                                                        <div class="input-box name-firstname">
                                                                            <label for="email"><em class="required">*</em>Password</label>
                                                                            <br>
                                                                            <input name="password"  id="password" title="Email" class="input-text required-entry validate-email" type="password">
                                                                        </div>
                                                                    </div>
                                                                </li>
                                                                <li>
                                                                    ...
                                                                    <br>
                                                                    <textarea name="address" id="address" title="Comment" class="required-entry input-text" cols="5" rows="3"></textarea>
                                                                </li>
                                                            </ul>
                                                        </fieldset>
                                                    </li>
