          ...
          <ul>
            <li>
              <div class="feature-box">
                <div class="icon-truck"><img src="{{asset('frontend/')}}/images/world-icon.png" alt="Image"></div>
                <div class="content">
                  <h6>World's #1</h6>
            ...
            <li>
              <div class="feature-box">
                <div class="icon-support"><img src="{{asset('frontend/')}}/images/car-sold-icon.png" alt="Image"></div>
                <div class="content">
                  <h6>Car Sold</h6>
                  <p>Every 4 minute</p>
                </div>
            ...
            <li>
              <div class="feature-box">
                <div class="icon-money"><img src="{{asset('frontend/')}}/images/tag-icon.png" alt="Image"></div>
                <div class="content">
                  <h6>Offers</h6>
            ...
            <li class="last">
              <div class="feature-box">
                <div class="icon-return"><img src="{{asset('frontend/')}}/images/compare-icon.png" alt="Image"></div>
                <div class="content">
                  <h6>Compare</h6>
      ...
      <div class="container">
        <div class="row">
          <div class="col-xs-12 col-sm-4">
            <div class="social">
              <ul>
                <li class="fb"><a href="https://www.facebook.com/techzonebdltd/" target="_blank"></a></li>
