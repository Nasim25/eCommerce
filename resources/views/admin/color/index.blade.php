...
<div class="content">
            <div class="content-header">
                <div class="leftside-content-header">
                    <ul class="breadcrumbs">
                        <li><i class="fa fa-table" aria-hidden="true"></i><a href="#">Color</a></li>
                        <li><a>Color List</a></li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row animated fadeInRight">
                    <div class="col-sm-12">
                        <h4 style="background: white;padding: 13px;border-radius: 3px;margin-bottom: 1px;" class="section-subtitle"><b>Color</b></h4>
                        <a href="{{ url('admin/color-insert')}}" class="btn btn-sm btn-success pull-right" style="margin-top: -40px; margin-right: 13px;">Add Color</a>
                        <div class="panel">
                            <div class="panel-content">
                                <table id="responsive-table" class="data-table table table-striped table-hover table-bordered responsive nowrap" cellspacing="0" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="brandUpdateStatus" href="{{url('admin/color-delete',$color->id)}}" id="">Delete</a>
